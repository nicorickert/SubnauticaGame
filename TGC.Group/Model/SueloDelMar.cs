...
namespace TGC.Group.Model
{
    public class SueloDelMar : HeightMapTextured 
    {
        ...
        public override void Init()
        {
            base.Init();
            InitMainMeshes();
            CrearObjetosEnElEscenario(mesh.getVertexPositions());
        }
        ...
        private void CrearObjetosEnElEscenario(TGCVector3[] vertices)
        {
            ...
            {
                TGCVector3 verticeActual = vertices[i * 6 + 1]; // Cada 6 es un vértice de otro triángulo
                TGCVector3 rotation = TGCVector3.Up * random.Next(10);
                int scale = random.Next(10, 30);
                TGCVector3 position = MathExtended.Vector3ToTGCVector3(verticeActual);
